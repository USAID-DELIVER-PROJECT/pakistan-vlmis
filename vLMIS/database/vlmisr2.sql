...
Source Database       : vlmisr2bk2

Target Server Type    : MYSQL
Target Server Version : 50612
File Encoding         : 65001

Date: 2015-11-20 20:03:23
*/
...
CREATE TABLE `ccm_status_history` (
  ...
  CONSTRAINT `ccm_status_history_ibfk_1` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`pk_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=582240 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=7383308 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=256590 DEFAULT CHARSET=utf8;
...
CREATE TABLE `hf_data_master_draft` (
  ...
  CONSTRAINT `hf_data_master_draft_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `users` (`pk_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3254789 DEFAULT CHARSET=utf8;
...
CREATE TABLE `location_populations` (
  ...
  KEY `created_by` (`created_by`),
  KEY `modified_by` (`modified_by`),
  CONSTRAINT `location_populations_ibfk_3` FOREIGN KEY (`modified_by`) REFERENCES `users` (`pk_id`),
  CONSTRAINT `location_populations_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `locations` (`pk_id`),
  CONSTRAINT `location_populations_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`pk_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=22462 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=112336 DEFAULT CHARSET=latin1;
...
CREATE TABLE `mos_scale` (
  ...
  CONSTRAINT `mos_scale_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `items` (`pk_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=46982 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=20308 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=48451 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=12881 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=63286 DEFAULT CHARSET=utf8;
...
CREATE TABLE `stock_batch_history` (
  ...
  KEY `created_by` (`created_by`),
  KEY `modified_by` (`modified_by`),
  CONSTRAINT `stock_batch_history_ibfk_6` FOREIGN KEY (`modified_by`) REFERENCES `users` (`pk_id`),
  CONSTRAINT `stock_batch_history_ibfk_1` FOREIGN KEY (`item_pack_size_id`) REFERENCES `item_pack_sizes` (`pk_id`),
  CONSTRAINT `stock_batch_history_ibfk_2` FOREIGN KEY (`vvm_type_id`) REFERENCES `vvm_types` (`pk_id`),
  CONSTRAINT `stock_batch_history_ibfk_3` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`pk_id`),
  CONSTRAINT `stock_batch_history_ibfk_4` FOREIGN KEY (`stakeholder_item_pack_size_id`) REFERENCES `stakeholder_item_pack_sizes` (`pk_id`),
  CONSTRAINT `stock_batch_history_ibfk_5` FOREIGN KEY (`created_by`) REFERENCES `users` (`pk_id`)
) ENGINE=InnoDB AUTO_INCREMENT=43697 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=272743 DEFAULT CHARSET=utf8;
...
CREATE TABLE `stock_detail_history` (
  ...
  KEY `created_by` (`created_by`),
  KEY `modified_by` (`modified_by`),
  CONSTRAINT `stock_detail_history_ibfk_6` FOREIGN KEY (`modified_by`) REFERENCES `users` (`pk_id`),
  CONSTRAINT `stock_detail_history_ibfk_1` FOREIGN KEY (`vvm_stage`) REFERENCES `vvm_stages` (`pk_id`),
  CONSTRAINT `stock_detail_history_ibfk_2` FOREIGN KEY (`stock_master_id`) REFERENCES `stock_master_history` (`pk_id`),
  CONSTRAINT `stock_detail_history_ibfk_3` FOREIGN KEY (`stock_batch_id`) REFERENCES `stock_batch` (`pk_id`),
  CONSTRAINT `stock_detail_history_ibfk_4` FOREIGN KEY (`item_unit_id`) REFERENCES `item_units` (`pk_id`),
  CONSTRAINT `stock_detail_history_ibfk_5` FOREIGN KEY (`created_by`) REFERENCES `users` (`pk_id`)
) ENGINE=InnoDB AUTO_INCREMENT=299480 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=76699 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1727 DEFAULT CHARSET=utf8 COMMENT='contain user information';
...
) ENGINE=InnoDB AUTO_INCREMENT=83049 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=10354 DEFAULT CHARSET=utf8 COMMENT='contain information about warehouse';
...
) ENGINE=InnoDB AUTO_INCREMENT=3997538 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=7140496 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=76239 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=17961 DEFAULT CHARSET=latin1;
...
DELIMITER ;;
CREATE DEFINER=`vlmis`@`%` FUNCTION `AdjustQty`(`batchId` int,`whId` int) RETURNS int(11)
    DETERMINISTIC
BEGIN 
  DECLARE receive INT;
  DECLARE issue INT;
  ...
  INNER JOIN  stock_master ON  stock_detail.stock_master_id  = stock_master.pk_id
	...
	SET qty = receive + issue + adjustment;
	 ...
	 IF(qty >= 0) THEN 
		 UPDATE  stock_batch  SET  quantity = qty	WHERE  pk_id=batchId;
	 END IF;

   IF(qty < 0) THEN
		 UPDATE  stock_batch  SET  quantity = 0, status='Finished'	WHERE  pk_id=batchId;
	 END IF;
...
BEGIN 
   DECLARE PlacedQty INTEGER;
			...
			placements
			WHERE
			placements.stock_detail_id = stock_detail_id and placements.placement_transaction_type_id in(115,116)
			LIMIT 1;
...
BEGIN 
   DECLARE PlacedQty INTEGER;
			...
			placements
			WHERE
			placements.stock_detail_id = stock_detail_id and placements.placement_transaction_type_id in(114,116)
			LIMIT 1;
...
-- ----------------------------
-- Function structure for REPUpdateCarryForward2
-- ----------------------------
DROP FUNCTION IF EXISTS `REPUpdateCarryForward2`;
DELIMITER ;;
CREATE DEFINER=`vlmis`@`%` FUNCTION `REPUpdateCarryForward2`(in_rpt_date DATE, in_item INTEGER, in_wh INTEGER) RETURNS int(4)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
SELECT number_of_doses INTO noOfDoses FROM item_pack_sizes WHERE item_id = in_item;
