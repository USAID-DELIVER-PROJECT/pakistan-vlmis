...
class Model_CcmWarehouses extends Model_Base {
    ...
    public function vaccineStorageCapacityAt2to8Report() {
        ...
        if (!empty($this->form_values['combo1']) && $this->form_values['facility_type'] == 2) {
            $where[] = "warehouses.province_id = " . $this->form_values['combo1'];
        }
                   ...
                   FROM
                    (
                     SELECT
                      ...
                      ifnull((
                       warehouse_population.capacity_4degree
                      ),0) AS ActualCap,
                      ifnull((
                       warehouse_population.requirments_4degree
                      ),0) AS Required,
                      ifnull((
                       warehouse_population.capacity_4degree
                      ) - (
...
locations.location_name AS District,
              warehouses.warehouse_name AS FacilityName,
              warehouse_types.warehouse_type_name AS FacilityType,
              warehouse_population.capacity_20degree AS ActualCap,
              warehouse_population.requirments_20degree AS Required,
              warehouse_population.capacity_20degree - warehouse_population.requirments_20degree AS Difference
             FROM
              warehouses
             INNER JOIN warehouse_types ON warehouses.warehouse_type_id = warehouse_types.pk_id
             INNER JOIN warehouse_population ON warehouse_population.warehouse_id = warehouses.pk_id             
        ...
        SELECT
           ...
           FROM
            (
             ...
             INNER JOIN locations AS Province ON warehouses.province_id = Province.pk_id
             " . $str_where . "
                 WHERE locations.geo_level_id IN (1,2)
            ) a ) b group by FacilityType
                    ";
        $row = $this->_em->getConnection()->prepare($str_qry);
        $row->execute();
        ...
        $str_qry = "SELECT
                   ...
                   FROM
                    ...
                    SELECT 
                     ...
                     warehouse_population.requirments_4degree AS req4,
                     warehouse_population.capacity_4degree AS cap4,
                     warehouse_population.capacity_4degree - warehouse_population.requirments_4degree AS diff4,
    ...
    public function getStorageCapacityByArea20c() {
        ...
        $str_qry = "SELECT
                   ...
                   FROM
                    ...
                    SELECT
                     warehouse_types.warehouse_type_name,
                     warehouse_population.requirments_20degree AS req20,
                     warehouse_population.capacity_20degree AS cap20,
                     warehouse_population.capacity_20degree - warehouse_population.requirments_20degree AS diff20,
                     District.location_name AS District,
                     Province.location_name AS Province
                    FROM
                        warehouses
