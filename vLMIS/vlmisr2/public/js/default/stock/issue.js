$(function () {
    ...
    $('#number, #transaction_date').change(function () {
        $.ajax({
            type: "POST",
            url: appName + "/stock-batch/ajax-available-batch-quantity",
            data: {batch: $('#number').val(), tr_date: $("#transaction_date").val()},
            dataType: 'html',
            success: function (data) {
...
//            $.ajax({
//                type: "POST",
//                url: appName + "/stock/ajax-get-all-stakeholder-activities",
...
//            $.ajax({
//                type: "POST",
//                url: appName + "/stock/ajax-get-stakeholder-activities",
//                data: {warehouse: $(this).val()},
//                dataType: 'html',
//                success: function(data) {
//                    $('#activity_id').html(data);
...
}, "Please select another warehouse");

$("#print_issue").click(function () {
    var id = $('#hdn_master_id').val();
    window.open(appName + '/stock/print-issue?id=' + id, '_blank', 'width=860,height=595');
});
